return {
    ...
    config = function()
        ...
        require("mason-lspconfig").setup({
            ensure_installed = vim.tbl_keys(require("plugins.lsp.languages")),
        })
        ...
        mason_lspconfig.setup_handlers({
            function(server_name)
                require("lspconfig")[server_name].setup({
                    ...
                    settings = require("plugins.lsp.languages")[server_name],
                    filetypes = (require("plugins.lsp.languages")[server_name] or {}).filetypes,
                })
            end,
        })
